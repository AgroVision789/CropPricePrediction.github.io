...
<body>
  ...
  <div class="contact-form py-5" id="contact">
    <div class="container py-lg-5 py-md-4">
      <h3 class="hny-title mb-lg-5 mb-4">Register</h3>
        <div class="contacts12-main mb-5">
          <form action="FarmerRegister" method="post">
                <div class="main-input">
                    <div class="d-grid">
                        <input type="text" name="fname" id="w3lName" placeholder="Farmer Name" class="contact-input" />
                        <input type="text" name="fmob" id="w3lPhone" placeholder="Phone Number"
                            class="contact-input" />
                    </div>
                    <div class="d-grid">
                        <input type="address" name="faddress" id="w3lSender" placeholder="Address"
                            class="contact-input" required />
                        <input type="password" name="fpass" id="w3lSubject" placeholder="Password"
                            class="contact-input" />
                    </div>
                </div>
