...
//      System.out.println("sss"+fname);
      ...
      <div class="main-panel">
		...
		<!--	Registration Form<br>!-->
                <form name="simple"  method="POST" action="trainbot_controller.jsp" >
                    <input type="text" id="req1" name="que"  placeholder="Question"><br><br>		
				<!--<input type="text" id="req2" placeholder="Lastname"><br><br>-->
				<input type="text" name="ans" id="req3" placeholder="Answers"><br><br>
				...
				<input type="submit" value="Submit" onclick="emailValidate(document.getElementById('req3'),'Invalid Email id.'),/*isNumeric(document.getElementById('req4'),'Enter digits in contact no.'),*/Selection(document.getElementById('selection'),'Please select gender')">
                   ...
                   <a href="http://localhost/FarmingBot/TrainData.php">For Marathi Train Data</a>
		</div>	
	</div>
